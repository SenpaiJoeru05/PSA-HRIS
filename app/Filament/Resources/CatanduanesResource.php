...
use App\Filament\Resources\CatanduanesResource\Pages;
...
class CatanduanesResource extends Resource
{
    protected static ?string $model = ProvincialOffice::class;
    protected static ?string $pluralModelLabel = 'CATANDUANES';

    protected static ?string $navigationIcon = 'heroicon-o-users';
    protected static ?string $navigationGroup = 'Province Offices';
    public static function getNavigationBadge(): ?string
    {
        return static::getModel()::where('office_name', 'Catanduanes Provincial Office')->count();
    }
    ...
    {
        return [
            'index' => Pages\ListCatanduanes::route('/'),
            'create' => Pages\CreateCatanduanes::route('/create'),
            'edit' => Pages\EditCatanduanes::route('/{record}/edit'),
        ];
    }
}

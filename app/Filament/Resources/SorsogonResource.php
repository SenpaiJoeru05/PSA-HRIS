...
use App\Filament\Resources\SorsogonResource\Pages;
...
class SorsogonResource extends Resource
{
    protected static ?string $model = ProvincialOffice::class;

    protected static ?string $pluralModelLabel = 'SORSOGON';

    protected static ?string $navigationIcon = 'heroicon-o-users';
    protected static ?string $navigationGroup = 'Province Offices';
    public static function getNavigationBadge(): ?string
    {
        return static::getModel()::where('office_name', 'Sorsogon Provincial Office')->count();
    }
    ...
    {
        return [
            'index' => Pages\ListSorsogons::route('/'),
            'create' => Pages\CreateSorsogon::route('/create'),
            'edit' => Pages\EditSorsogon::route('/{record}/edit'),
        ];
    }
}

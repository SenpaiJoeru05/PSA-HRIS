...
use App\Filament\Resources\CamarinesNorteResource\Pages;
...
class CamarinesNorteResource extends Resource
{
    protected static ?string $model = ProvincialOffice::class;

    protected static ?string $pluralModelLabel = 'CAMARINES NORTE';

    protected static ?string $navigationIcon = 'heroicon-o-users';
    protected static ?string $navigationGroup = 'Province Offices';
    public static function getNavigationBadge(): ?string
    {
        return static::getModel()::where('office_name', 'Camarines Norte Provincial Office')->count();
    }
    ...
    {
        return [
            'index' => Pages\ListCamarinesNortes::route('/'),
            'create' => Pages\CreateCamarinesNorte::route('/create'),
            'edit' => Pages\EditCamarinesNorte::route('/{record}/edit'),
        ];
    }
}

...
use App\Filament\Resources\CamarinesSurResource\Pages;
use App\Filament\Resources\CamarinesSurResource\RelationManagers;
use App\Models\CamarinesSur;
...
class CamarinesSurResource extends Resource
{
    protected static ?string $model = ProvincialOffice::class;

    protected static ?string $pluralModelLabel = 'CAMARINES SUR';

    protected static ?string $navigationIcon = 'heroicon-o-users';
    protected static ?string $navigationGroup = 'Province Offices';
    public static function getNavigationBadge(): ?string
    {
        return static::getModel()::where('office_name', 'Camarines Sur Provincial Office')->count();
    }
    ...
    public static function form(Form $form): Form
    {
        ...
        ->schema([
            Select::make('employee_id')
                ...
                ->allowHtml() // Enable HTML in the options
    ...
    {
        return [
            'index' => Pages\ListCamarinesSurs::route('/'),
            'create' => Pages\CreateCamarinesSur::route('/create'),
            'edit' => Pages\EditCamarinesSur::route('/{record}/edit'),
        ];
    }
}

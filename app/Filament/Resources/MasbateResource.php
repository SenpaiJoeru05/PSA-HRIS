...
use App\Filament\Resources\MasbateResource\Pages;
...
class MasbateResource extends Resource
{
    protected static ?string $model = ProvincialOffice::class;
    protected static ?string $pluralModelLabel = 'MASBATE';

    protected static ?string $navigationIcon = 'heroicon-o-users';
    protected static ?string $navigationGroup = 'Province Offices';
    public static function getNavigationBadge(): ?string
    {
        return static::getModel()::where('office_name', 'Masbate Provincial Office')->count();
    }
    ...
    {
        return [
            'index' => Pages\ListMasbates::route('/'),
            'create' => Pages\CreateMasbate::route('/create'),
            'edit' => Pages\EditMasbate::route('/{record}/edit'),
        ];
    }
}

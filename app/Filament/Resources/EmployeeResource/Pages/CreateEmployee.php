...
class CreateEmployee extends CreateRecord
{
    ...
    protected function getSteps(): array
    {
        return [
            //STEP 1 USER ACCOUNT
           Forms\Components\Wizard\Step::make('Employee Account')
                ->schema([
            ...
            ->schema([
                ...
                Grid::make(2)
                    ->schema([
                        ...
                        Radio::make('password_option')
                            ->label('Password Option')
                            ->live()
                            ->options([
                                'default' => 'Use Default Password (RSSO5!PASS)',
                                'custom' => 'Set Password',
                            ])
                        ...
                        Password::make('custom_password')
                            ->label('Set Password')
                            ->password()
                            ->rules('nullable|min:8|regex:/[0-9]/') // Min length 8 and 
                            ->columnSpan(2)
                            ->hidden(fn ($get) => $get('password_option') !== 'custom')
                            ->required(fn ($get) => $get('password_option') === 'custom'),
                        
                        Password::make('custom_password_confirmation')
                            ...
                            ->schema([
                                ...
                                Group::make([
                                    TextInput::make('permanent_province')
                                        ...
                                        ->hiddenLabel()
                                        ->nullable()
                                        ->disabled(fn (Forms\Get $get) => $get('permanent_address_same_as_residential')),
                ...
                ->schema([
                    ...
                    ->schema([
                       ...
                       ->schema([
                            ...
                            ->hidden(fn (Forms\Get $get) => $get('spouse_not_applicable')),
                            ]),
                        ...
                        ->schema([
                                ...
                                ->hidden(fn (Forms\Get $get) => $get('father_not_applicable')),
                                ]),
                        ...
                        ->label('Please Check if not applicable'),
                            ...
                            ->hidden(fn (Forms\Get $get) => $get('mother_not_applicable')),
                        ]),
                            ...
                            Group::make([
                                ...
                                TextInput::make('children_first_name')
                                 ...
                                 TextInput::make('children_name_extension')
                                    ...
                                    ->hidden(fn (Forms\Get $get) => $get('children_not_applicable')),
                                ])
                    ...
                    Forms\Components\Wizard\Step::make('Educational Background')
                                        ...
                                        Section::make('Secondary')
                                            ...
                                            ->schema([
                                                ...
                                                Group::make([
                                                    ...
                                                    ->hidden(fn (Forms\Get $get) => $get('vocational_not_applicable')),
                                            ]),
                                        ...
                                        Section::make('College')
                                            ...
                                            ->schema([
                                                ...
                                                Group::make([
                                                    ...
                                                    ->hidden(fn (Forms\Get $get) => $get('graduate_not_applicable')),
                                            ]),
                                            ...
                                            ->schema([
                                                ...
                                                ->schema([
                                                    TextInput::make('eligibility')
                                                        ...
                                                        ->required()
                                                        ->hidden(fn (Forms\Get $get) => $get('civil_service_eligibility_not_applicable')),
                                                    ...
                                                    Section::make('Work Experience Details')
                                                        ->schema([
                                                            DatePicker::make('inclusive_dates_from')
                                                                ...
                                                                ->hidden(fn (Forms\Get $get) => $get('work_experience_not_applicable')),
                            ...
                            Forms\Components\Wizard\Step::make('Voluntary Work')
                            ->schema([
                                                    ...
                                                    Section::make('Voluntary Work Details')
                                                        ->schema([
                                                            TextInput::make('organization_name')
                                                                ...
                                                                ->nullable()
                                                                ->hidden(fn (Forms\Get $get) => $get('voluntary_work_not_applicable')),
                        ...
                        //STEP 8 LEARNING AND DEVELOPMENT
                            Forms\Components\Wizard\Step::make('Learning & Development')
                            ->schema([
                                                    ...
                                                    Section::make('Learning & Development Details')
                                                        ->schema([
                                                            TextInput::make('title')
                                                                ...
                                                                ->nullable()
                                                                ->hidden(fn (Forms\Get $get) => $get('learning_development_not_applicable')),
                            ...
                            Forms\Components\Wizard\Step::make('Other Information')
                            ->schema([
    ...
    {
        $role = strtolower($data['role']); // Convert role to lowercase
        $firstName = strtolower($data['first_name']); // Assuming you have first_name in $data
        $employeeId = Employee::max('id') + 1; // Get next employee ID (assumes auto-increment)

        $username = $role . '-' . $firstName . '-' . $employeeId;

        $password = ($data['password_option'] === 'custom') ? $data['custom_password'] : 'RSSO5!PASS';
        ...
        // Insert the employee
        $employee = static::getModel()::create(array_merge($data, ['user_id' => $user->id])); 
